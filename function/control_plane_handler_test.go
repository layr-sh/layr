...
func TestFunctionControlPlaneHandlerUnit(t *testing.T) {
	...
	t.Run("scope check failures across control plane handlers", func(t *testing.T) {
		...
		getEndpointRequest.SetPathValue("endpoint_id", "abc")
		...
		updateEndpointRequest.SetPathValue("endpoint_id", "abc")
		...
		deleteEndpointRequest.SetPathValue("endpoint_id", "abc")
		...
		deployRequest.SetPathValue("endpoint_id", "abc")
		...
		listDeploymentsRequest.SetPathValue("endpoint_id", "abc")
		...
		rollbackRequest.SetPathValue("endpoint_id", "abc")
		...
		deleteDomainRequest.SetPathValue("domain_id", "abc")
		...
		createRouteRequest.SetPathValue("endpoint_id", "abc")
		...
		listRoutesRequest.SetPathValue("endpoint_id", "abc")
		...
		deleteRouteRequest.SetPathValue("endpoint_id", "abc")
