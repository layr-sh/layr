...
func TestTasksRouterUnit(t *testing.T) {
	...
	require.NotNil(t, controlPlaneOpenAPISpec.Paths.Value("/v1/_/tasks/jobs/{id}"))
	...
	require.NotNil(t, controlPlaneOpenAPISpec.Paths.Value("/v1/_/tasks/dlq/{id}/retry"))
	require.NotNil(t, controlPlaneOpenAPISpec.Paths.Value("/v1/_/tasks/dlq/{id}"))
