...
func (service *Service) RegisterRoutes(publicRouter *core.Router, controlPlaneRouter *core.Router) {
	if publicRouter != nil {
		service.registerPublicRoutes(publicRouter)
	}
...
func (service *Service) registerPublicRoutes(router *core.Router) {
	if service.handler == nil {
		return
	}

	// 1. OIDC Discovery & JWKS
	core.GetRoute[jwt.OIDCConfiguration](router, "/.well-known/openid-configuration", service.handler.handleOIDCDiscovery,
	...
	core.GetRoute[jwt.JWKS](router, "/.well-known/jwks.json", service.handler.handleJWKS,
		core.RouteTag("OpenID Connect"),
	...
	// 2. Anonymous Auth
	core.PostRoute[SessionResponse, AnonymousSignInRequest](router, "/api/v1/auth/anonymous", service.handler.handleAnonymousSignIn,
	...
	// 3. Password Auth
	core.PostRoute[SessionResponse, SignUpRequest](router, "/api/v1/auth/sign-up", service.handler.handleSignUp,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[SessionResponse, SignInRequest](router, "/api/v1/auth/sign-in", service.handler.handleSignIn,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[core.Empty, core.Empty](router, "/api/v1/auth/sign-out", service.handler.handleSignOut,
		core.RouteTag("Authentication"),
		core.RouteSummary("Revoke active session and refresh token"),
		core.RouteDescription("Revokes the active refresh token and invalidates the session record in layr_auth.sessions."),
	...
	core.PostRoute[SessionResponse, RefreshTokenRequest](router, "/api/v1/auth/token/refresh", service.handler.handleTokenRefresh,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[core.Empty, PasswordResetRequest](router, "/api/v1/auth/password-reset/request", service.handler.handlePasswordResetRequest,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[core.Empty, PasswordResetConfirmRequest](router, "/api/v1/auth/password-reset/confirm", service.handler.handlePasswordResetConfirm,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[passkey.SignUpOptions, PasskeySignUpRequest](router, "/api/v1/auth/passkeys/sign-up", service.handler.handlePasskeySignUp,
	...
	core.PostRoute[core.Empty, PasskeySignUpVerifyRequest](router, "/api/v1/auth/passkeys/sign-up/verify", service.handler.handlePasskeySignUpVerify,
		core.RouteTag("Passkeys"),
		core.RouteSummary("Verify WebAuthn passkey registration attestation"),
		core.RouteDescription("Validates the WebAuthn attestation response and stores the public key credential in layr_auth.identities."),
	...
	core.PostRoute[passkey.SignInOptions, core.Empty](router, "/api/v1/auth/passkeys/sign-in", service.handler.handlePasskeySignIn,
		core.RouteTag("Passkeys"),
	...
	core.PostRoute[SessionResponse, PasskeySignInVerifyRequest](router, "/api/v1/auth/passkeys/sign-in/verify", service.handler.handlePasskeySignInVerify,
		core.RouteTag("Passkeys"),
	...
	// 5. Passwordless OTP
	core.PostRoute[core.Empty, OTPSendRequest](router, "/api/v1/auth/otp", service.handler.handleOTPSend,
	...
	core.PostRoute[SessionResponse, OTPVerifyRequest](router, "/api/v1/auth/otp/verify", service.handler.handleOTPVerify,
		core.RouteTag("Passwordless"),
	...
	core.PostRoute[MFASetupResponse, MFASetupRequest](router, "/api/v1/auth/mfa", service.handler.handleMFASetup,
	...
	core.PostRoute[SessionResponse, MFAVerifyRequest](router, "/api/v1/auth/mfa/verify", service.handler.handleMFAVerify,
		core.RouteTag("Multi-Factor Authentication"),
	...
	core.GetRoute[core.Empty](router, "/api/v1/auth/oauth/authorize", service.handler.handleOIDCAuthorize,
		core.RouteTag("OpenID Connect"),
	...
	core.GetRoute[core.Empty](router, "/api/v1/auth/oauth/{provider}/authorize", service.handler.HandleOAuthAuthorize,
		core.RouteTag("OAuth"),
	...
	core.PostRoute[OIDCTokenResponse, core.Empty](router, "/api/v1/auth/oauth/token", service.handler.handleOIDCToken,
		core.RouteTag("OpenID Connect"),
	...
	core.GetRoute[OIDCUserInfoResponse](router, "/api/v1/auth/oauth/userinfo", service.handler.handleOIDCUserInfo,
		core.RouteTag("OpenID Connect"),
	...
	router.Mux().HandleFunc("POST /api/v1/auth/oauth/authorize", service.handler.handleOIDCAuthorizeSubmit)
	router.Mux().HandleFunc("GET /api/v1/auth/oauth/sign-out", service.handler.handleOIDCSignOut)
	router.Mux().HandleFunc("POST /api/v1/auth/oauth/sign-out", service.handler.handleOIDCSignOut)
	router.Mux().HandleFunc("GET /api/v1/auth/oauth/{provider}/callback", service.handler.HandleOAuthCallback)
	router.Mux().HandleFunc("POST /api/v1/auth/oauth/{provider}/callback", service.handler.HandleOAuthCallback)

	// Runtime password reset and action aliases
	router.Mux().HandleFunc("POST /api/v1/auth/password/reset", service.handler.handlePasswordResetRequest)
	router.Mux().HandleFunc("POST /api/v1/auth/password/reset/confirm", service.handler.handlePasswordResetConfirm)
	router.Mux().HandleFunc("POST /api/v1/auth/otp/send", service.handler.handleOTPSend)
	router.Mux().HandleFunc("POST /api/v1/auth/mfa/setup", service.handler.handleMFASetup)

	// 8. GDPR Export
	core.PostRoute[ExportUserDataResponse, core.Empty](router, "/api/v1/auth/users/{user_id}/export", service.handler.handleUserExport,
	...
	core.GetRoute[ListUserSessionsResponse](router, "/api/v1/auth/sessions", service.handler.handleListSessions,
		core.RouteTag("Authentication"),
	...
	core.DeleteRoute[core.Empty](router, "/api/v1/auth/sessions/{session_id}", service.handler.handleRevokeSession,
		core.RouteTag("Authentication"),
	...
	core.PostRoute[RevokeOtherSessionsResponse, core.Empty](router, "/api/v1/auth/sessions/revoke-others", service.handler.handleRevokeOtherSessions,
		core.RouteTag("Authentication"),
	...
	router.Mux().HandleFunc("GET /api/v1/auth/user/sessions", service.handler.handleListSessions)
	router.Mux().HandleFunc("DELETE /api/v1/auth/user/sessions/{session_id}", service.handler.handleRevokeSession)
	router.Mux().HandleFunc("POST /api/v1/auth/user/sessions/revoke-others", service.handler.handleRevokeOtherSessions)

	// 10. User Self-Service Account Management
	core.GetRoute[UserResponse](router, "/api/v1/auth/user", service.handler.handleGetUser,
	...
	core.PatchRoute[UpdateUserPropertiesResponse, UpdateUserPropertiesRequest](router, "/api/v1/auth/user/properties", service.handler.handleUpdateUserProperties,
		core.RouteTag("User Self-Service"),
	...
	core.PatchRoute[core.Empty, UpdateUserEmailRequest](router, "/api/v1/auth/user/email", service.handler.handleUpdateUserEmail,
		core.RouteTag("User Self-Service"),
	...
	core.PostRoute[core.Empty, UserEmailVerificationRequest](router, "/api/v1/auth/user/email/verification/request", service.handler.handleUserEmailVerificationRequest,
		core.RouteTag("User Self-Service"),
	...
	core.PostRoute[core.Empty, UserEmailVerificationConfirmRequest](router, "/api/v1/auth/user/email/verification/confirm", service.handler.handleUserEmailVerificationConfirm,
		core.RouteTag("User Self-Service"),
	...
	core.PatchRoute[core.Empty, UpdateUserPhoneRequest](router, "/api/v1/auth/user/phone", service.handler.handleUpdateUserPhone,
		core.RouteTag("User Self-Service"),
	...
	core.PostRoute[core.Empty, UserPhoneVerificationRequest](router, "/api/v1/auth/user/phone/verification/request", service.handler.handleUserPhoneVerificationRequest,
		core.RouteTag("User Self-Service"),
	...
	core.PostRoute[core.Empty, UserPhoneVerificationConfirmRequest](router, "/api/v1/auth/user/phone/verification/confirm", service.handler.handleUserPhoneVerificationConfirm,
		core.RouteTag("User Self-Service"),
	...
	core.PatchRoute[core.Empty, UpdateUserPasswordRequest](router, "/api/v1/auth/user/password", service.handler.handleUpdateUserPassword,
		core.RouteTag("User Self-Service"),
	...
	core.DeleteRoute[core.Empty](router, "/api/v1/auth/user", service.handler.handleDeleteUser,
		core.RouteTag("User Self-Service"),
