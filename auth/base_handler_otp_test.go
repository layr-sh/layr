...
func TestAuthOTPHandlerUnit(t *testing.T) {
	...
	baseHandler.handleOTPVerify(verifyDisabledResponseRecorder, verifyDisabledRequest)
	...
	baseHandler.handleOTPSend(missingRecipientResponseRecorder, missingRecipientRequest)
	...
	baseHandler.handleOTPVerify(missingCodeResponseRecorder, missingCodeRequest)
	...
	baseHandler.handleOTPSend(invalidPhoneSendResponseRecorder, invalidPhoneSendRequest)
	...
	baseHandler.handleOTPVerify(invalidPhoneVerifyResponseRecorder, invalidPhoneVerifyRequest)
	...
	baseHandler.handleOTPSend(smsDisabledSendResponseRecorder, smsDisabledSendRequest)
	...
	baseHandler.handleOTPVerify(smsDisabledVerifyResponseRecorder, smsDisabledVerifyRequest)
	...
	baseHandler.handleOTPSend(emailDisabledSendResponseRecorder, emailDisabledSendRequest)
	...
	baseHandler.handleOTPVerify(emailDisabledVerifyResponseRecorder, emailDisabledVerifyRequest)
	...
	baseHandler.handleOTPSend(eventOTPSendResponseRecorder, eventOTPSendRequest)
