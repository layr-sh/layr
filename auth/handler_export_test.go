...
func TestAuthHandlerExportUnit(t *testing.T) {
	...
	handler.handleUserExport(missingPathResponseRecorder, missingPathRequest)
	...
	handler.handleUserExport(missingBearerResponseRecorder, missingBearerRequest)
	...
	handler.handleUserExport(mismatchedResponseRecorder, mismatchedRequest)
	...
	handler.handleUserExport(matchedResponseRecorder, matchedRequest)
