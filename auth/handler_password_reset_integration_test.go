...
func TestAuthPasswordResetFlowIntegration(t *testing.T) {
	...
	handler.SetSMSDispatcher(NewSMSDispatcher(db, func() *SMSDispatcherConfig {
	...
	handler.handlePasswordResetRequest(resetEmailResponseRecorder, resetEmailRequest)
	...
	handler.handlePasswordResetRequest(cooldownResponseRecorder, cooldownRequest)
	...
	handler.handlePasswordResetRequest(rateLimitResponseRecorder, rateLimitRequest)
	...
	handler.handlePasswordResetRequest(ghostResetResponseRecorder, ghostResetRequest)
	...
	handler.handlePasswordResetRequest(resetPhoneResponseRecorder, resetPhoneRequest)
	...
	handler.handlePasswordResetConfirm(phoneConfirmResponseRecorder, phoneConfirmRequest)
	...
	handler.handlePasswordResetConfirm(maxAttemptsResponseRecorder, maxAttemptsRequest)
	...
	handler.handlePasswordResetConfirm(ghostConfirmResponseRecorder, ghostConfirmRequest)
	...
	handler.handlePasswordResetConfirm(orphanConfirmResponseRecorder, orphanConfirmRequest)
