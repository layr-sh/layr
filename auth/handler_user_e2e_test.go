...
func TestAuthEmailVerificationFullLifecycleE2E(t *testing.T) {
	...
	serveMux.HandleFunc("POST /api/v1/auth/user/email/verification/request", handler.handleUserEmailVerificationRequest)
	serveMux.HandleFunc("POST /api/v1/auth/user/email/verification/confirm", handler.handleUserEmailVerificationConfirm)
...
func TestAuthPhoneVerificationFullLifecycleE2E(t *testing.T) {
	...
	serveMux := http.NewServeMux()
	serveMux.HandleFunc("POST /api/v1/auth/user/phone/verification/request", handler.handleUserPhoneVerificationRequest)
	serveMux.HandleFunc("POST /api/v1/auth/user/phone/verification/confirm", handler.handleUserPhoneVerificationConfirm)
