...
func (handler *Handler) HandleOAuthAuthorize(responseWriter http.ResponseWriter, request *http.Request) {
...
func (handler *Handler) HandleOAuthCallback(responseWriter http.ResponseWriter, request *http.Request) {
...
func (handler *Handler) HandleOAuthUserInfo(responseWriter http.ResponseWriter, request *http.Request) {
