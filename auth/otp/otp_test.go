...
func TestOtpGenerationAndVerificationUnit(t *testing.T) {
	...
	t.Run("StandardOTPCodeGeneration", func(t *testing.T) {
	...
	t.Run("HashCodeComputationAndWhitespaceTrimming", func(t *testing.T) {
	...
	t.Run("ConstantTimeCodeVerification", func(t *testing.T) {
		whitespacePaddedCode := "  " + otpCode + " \t\n"
	...
	t.Run("ZeroPaddingTest", func(t *testing.T) {
	...
	t.Run("ExpirationCheckEdgeCases", func(t *testing.T) {
		now := time.Now().UTC()
	...
	t.Run("EntropyErrorHandling", func(t *testing.T) {
	...
	t.Run("ConstantsAndRecordSerialization", func(t *testing.T) {
