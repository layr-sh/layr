...
func TestDataControlPlaneHandlerBaseScopeIntegration(t *testing.T) {
	...
	validRequest := httptest.NewRequestWithContext(ctx, http.MethodGet, "/api/v1/_/data/tables", nil)
	...
	invalidScopeRequest := httptest.NewRequestWithContext(ctx, http.MethodPost, "/api/v1/_/data/tables", nil)
	...
	malformedTokenRequest := httptest.NewRequestWithContext(ctx, http.MethodGet, "/api/v1/_/data/tables", nil)
